...
This contract describes the IPC surface exposed by `resources/app.asar.src/electron/preload.js` and handled in `resources/app.asar.src/electron/main.js`.
...
Workspace file actions and terminal commands must go through Flask routes so workspace authorization, permission checks, and audit logging apply.
