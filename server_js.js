        ...
        const tools = {"calculator": {"name": "计算器", "description": "执行数学计算，支持复杂表达式", "icon": "🔢"}, "weather": {"name": "天气查询", "description": "查询城市天气信息", "icon": "🌤️"}, "search": {"name": "网络搜索", "description": "搜索网络获取实时信息", "icon": "🔍"}, "webfetch": {"name": "网页抓取", "description": "抓取网页内容", "icon": "📄"}, "news": {"name": "新闻搜索", "description": "搜索最新新闻", "icon": "📰"}, "translate": {"name": "翻译", "description": "多语言翻译", "icon": "🌐"}, "datetime": {"name": "时间查询", "description": "获取当前日期时间", "icon": "🕐"}, "random": {"name": "随机数", "description": "生成随机数", "icon": "🎲"}};
